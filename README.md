...
**WebClient** — client construction, API calls (`auth.test`, `chat.postMessage`, `files.uploadV2`, `conversations.list`), pagination, custom fetch/proxy, timeouts, and error types.
